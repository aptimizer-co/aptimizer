    ...
    switch (type) {
        ...
        return (
          <div className={s.Feature}>
            <div className={s.textContainer}>
              <p className={s.title}>01 AI를 활용한 개인 맞춤형 적성 진단 검사</p>
              <p className={s.content}>
                서울대, 연세대, 고려대 및 국내 30여 주요 대학 학과의 교수진 139명과 대학생 및 재학생 300여 명이 참여하여
                개발한 139개의 학과 프로파일과 4,134개에 달하는 문항 데이터베이스를 학습한 인공지능이 여러분의 적성을
                정확하게 진단해 줍니다.
              </p>
              <p className={s.content}>
                또한 응답을 실시간으로 분석해 개인별로 적합한 문항을 제시하여 맞춤형 진단을 제공합니다.
              </p>
            </div>
        ...
        return (
          <div className={s.Feature}>
            <div className={s.textContainer}>
              ...
              <p className={s.content}>
                대학생 800여 명, 대학원생 1,000여 명을 대상으로 적성 진단의 정확도를 검증하였습니다.
              </p>
              <p className={s.content}>
                인공지능 거대 언어 모델과 커리어넷, 워크넷, 대학 학과 홈페이지 등의 공개 정보 300만 건을 학습한
                인공지능인 앱티핏이 정확한 적성 진단을 제공합니다.
              </p>
            </div>
            <div className={s.imgContainer}>
      ...
      case "B2C3":
        return (
          <div className={s.Feature}>
            <div className={s.textContainer}>
              <p className={s.title}>03 전공과 진로 선택에 필요한 상세한 정보 제공</p>
              <p className={s.content}>
                역량, 흥미, 가치, 개인 특성, 지식의 5가지 적성 요소와 나의 강점과 약점에 관한 상세한 분석을 제공해
                드립니다.
              </p>
              <p className={s.content}>
                적성에 관한 정보뿐만 아니라, 해당 학과 소개, 인재상, 교육과정을 알려드리며, 나의 희망 학과와 적성 학과를
                비교해 드립니다. 더 나아가 학과를 졸업하고 진출하는 직업 분야의 연봉, 직업 만족도 등 진로 설계에 필요한
                13개 요소, 30개 항목에 관한 정보를 제공합니다.
              </p>
            </div>
            <div className={s.imgContainer}>
