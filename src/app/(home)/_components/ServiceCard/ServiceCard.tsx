  ...
  const renderServiceCard = (service) => {
    switch (service) {
      case "앱티핏 검사 서비스":
        return (
          <div className={s.ServiceCard}>
            <div className={`${s.imgContainer} ${s.service1}`}>
              <Image className={s.img} src={Service1} alt="" fill />
            </div>
      ...
      case "진로 챗봇 서비스":
        return (
          <div className={s.ServiceCard}>
            <div className={`${s.imgContainer} ${s.service2}`}>
              <Image className={s.img} src={Service2} alt="" fill />
            </div>
            <div className={s.textContainer}>
      ...
      case "진로 PT 서비스 구독":
        return (
          <div className={s.ServiceCard}>
            <div className={`${s.imgContainer} ${s.service3}`}>
              <Image className={s.img} src={Service3} alt="" fill />
            </div>
            <div className={s.textContainer}>
      ...
      case "프리미엄 교육 서비스":
        return (
          <div className={s.ServiceCard}>
            <div className={`${s.imgContainer} ${s.service4}`}>
              <Image className={s.img} src={Service4} alt="" fill />
            </div>
            <div className={s.textContainer}>
      ...
      case "역량 분석/진단 개발 서비스":
        return (
          <div className={s.ServiceCard}>
            <div className={`${s.imgContainer} ${s.service5}`}>
              <Image className={s.img} src={Service5} alt="" fill />
            </div>
            <div className={s.textContainer}>
      ...
      case "앱티핏 단체 검사":
        return (
          <div className={s.ServiceCard}>
            <div className={`${s.imgContainer} ${s.service6}`}>
              <Image className={s.img} src={Service6} alt="" fill />
            </div>
            <div className={s.textContainer}>
