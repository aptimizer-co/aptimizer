    ...
    <section className={s.ScheduleSection}>
      ...
      <div className={s.scheduleContainer}>
        <div className={s.day}>
          ...
          <p className={s.dayDesc}>AI기반 학과적성진단을 통한 참여 학생의 정확한 적성 진단</p>
        </div>
        <div className={s.days}>
          ...
          <div className={s.day}>
            ...
            <p className={s.dayDesc}>디지털 대전환시대에 걸맞은 DT체험교육 (8시간)</p>
          </div>
          <div className={s.day}>
            <p className={s.dayTitle}>
              <span className={s.num}>4</span> 에듀프리미엄 학부모 특강
            </p>
            <p className={s.dayDesc}>자녀의 진로 이해를 위한 학부모 특강 (2시간)</p>
          </div>
        </div>
        <div className={s.day}>
          <p className={s.dayTitle}>
            <span className={s.num}>5</span>에듀 프리미엄 온라인 멘토링
          </p>
          <p className={s.dayDesc}>
            참여자의 단기적인 자극이 아닌, 장기적이고 지속적인 변화를 위한 지속적인 온라인 멘토링 (주 1회 3시간, 총 4회)
          </p>
        </div>
      </div>
    </section>
